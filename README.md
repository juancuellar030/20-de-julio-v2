...
4. **Invitación** — Tarjeta del evento escolar, música de fondo, opciones para reintentar o volver al inicio
...
| Archivo | Ruta |
|---------|------|
| Logo del colegio | `public/assets/school-logo.png` |
| Himno (solo audio) | `public/assets/Himno Nacional de la Republica de Colombia.mp3` |
| Música del quiz | `public/assets/Carmentea (Instrumental).mp3` |
| Música de invitación | `public/assets/invitation-music.mp3` |
| Tarjeta de invitación | `public/assets/invitation-card.jpeg` |
...
- [GSAP](https://gsap.com/) — transición en espiral del quiz
